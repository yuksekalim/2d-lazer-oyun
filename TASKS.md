...
- [x] Apply the light editorial UI pass: brighter palette, enlarged lives and board metadata, top difficulty selector, responsive metadata layout, and accessible interaction states.
